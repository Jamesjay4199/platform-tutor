    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="exampleFormControlFile1">Update your photo</label>
          ...
          <div class="form-group">
            ...
            <textarea name="about" id=about placeholder="Tell us more about yourself" class="form-control" value="{{$user->teacher->about}}">{{$user->teacher->about}}</textarea>
          </div>
          <div class="form-group">
