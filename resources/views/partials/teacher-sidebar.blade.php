...
<div class="col-2 nav-col">
  <div class="list-group mb-5 text-center" id="list-tab" role="tablist">
    ...
    <a class="list-group-item list-group-item-action {{$active=='subjects'? 'active': ''}}" id="list-mysubjects-list" href="/{{Auth::user()->username}}/subjects" ><i class="fas fa-book"></i> My Subjects</a>
